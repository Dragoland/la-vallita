...
const Legado: React.FC = () => {
  ...
  return (
    <section
      ...
      style={{
        background: 'linear-gradient(135deg, var(--soil-dark), var(--soil))',
        padding: '6rem 1.5rem',
        color: 'var(--white)',
      }}
    >
      ...
      <div className="max-w-[1200px] mx-auto">
        <SectionHeader
          label="El hombre y la tierra"
          title="El legado de Emilio"
          subtitle="Más que un productor, un investigador que escribió su nombre en la tierra"
          dark
        />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-start">
          ...
          <div>
            ...
            {/* Quote */}
            <blockquote
              className="my-8 pl-6 border-l-[3px] font-serif italic text-lg leading-relaxed"
              style={{ borderColor: 'var(--wheat)', color: 'rgba(255,255,255,0.9)' }}
            >
          ...
          <div ref={statsRef} className="grid grid-cols-2 gap-4">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="legado-stat text-center p-6 rounded-xl transition-all duration-300 hover:-translate-y-1"
                style={{
              ...
              >
                <span
                  ...
                  style={{ fontSize: '1.8rem', color: 'var(--wheat)' }}
                >
                  {stat.num}
                </span>
                <span
