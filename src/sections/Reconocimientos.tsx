...
const Reconocimientos: React.FC = () => {
  ...
  return (
    <section id="reconocimientos" style={{ background: 'var(--cream)', padding: '6rem 1.5rem' }}>
      <div className="max-w-[1200px] mx-auto">
        ...
        <div ref={ref} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {reconocimientos.map((rec, i) => (
            <div key={i} className="group relative bg-white rounded-2xl p-7 transition-all duration-300 hover:-translate-y-1.5" style={{ boxShadow: '0 4px 20px var(--shadow)', border: '1px solid rgba(139, 105, 20, 0.08)' }}>
              ...
              <span className="inline-block font-mono text-xs font-bold uppercase tracking-wider mb-3" style={{ color: 'var(--wheat)' }}>{rec.year}</span>
