    ...
    >
      ...
      <div className="max-w-[1200px] mx-auto">
        <SectionHeader
          label="Nuestra Raíz"
          title="Historia"
          subtitle="De la visión de Emilio al legado que hoy retomamos"
        />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          ...
          <div>
            <h3
              className="font-serif font-bold text-2xl lg:text-3xl mb-6"
              style={{ color: 'var(--soil)', lineHeight: 1.3 }}
            >
            ...
            <div ref={timelineRef} className="relative pl-8 my-8">
              ...
              <div
                ...
                style={{ background: 'linear-gradient(180deg, var(--wheat), var(--leaf))' }}
              />
            ...
            {/* Founder card */}
            <div
              className="relative rounded-r-xl p-6 lg:p-8 my-8"
              style={{
            ...
            >
              <div
                className="absolute -top-3 left-6 w-12 h-12 rounded-full"
                style={{ background: 'var(--wheat)', opacity: 0.12 }}
              />
              <strong
                className="block font-serif text-xl font-bold mb-3"
                style={{ color: 'var(--soil-dark)' }}
              >
                Emilio Chávez Estévez
              </strong>
              <p className="text-sm leading-relaxed" style={{ color: 'var(--text-soft)' }}>
          ...
          <div className="flex flex-col gap-6">
            <div
              ...
              style={{ boxShadow: '0 12px 40px var(--shadow-strong)' }}
            >
              <div
              ...
              />
              <ImagePlaceholder
                label="Fotografía de la finca"
                sublabel="Reemplazar con imagen real — Vista panorámica de La Vallita, Falcón"
                height="500px"
              />
            </div>
            ...
            >
              <ImagePlaceholder
                label="Detalle de la finca"
                sublabel="Reemplazar con imagen real — Injerto o plantas en vivero"
                height="280px"
              />
            </div>
          </div>
